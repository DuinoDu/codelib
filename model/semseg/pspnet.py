...
class pspnet(nn.Module):
    ...
    def __init__(self, feature_scale=4, n_classes=21, is_deconv=True, in_channels=3, is_batchnorm=True):
        ...
        # Final Classifier
        self.finaldeconvbnrelu1 = nn.Sequential(nn.ConvTranspose2d(filters[0], 32/feature_scale, 3, 2, 1, 1),
...
if __name__ == "__main__":
    ...
    net = pspnet(feature_scale=1, n_classes=1, is_deconv=True, in_channels=3, is_batchnorm=True)
