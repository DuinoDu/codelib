...
class linknet(nn.Module):
    ...
    def __init__(self, feature_scale=4, n_classes=21, is_deconv=True, in_channels=3, is_batchnorm=True):
        ...
        # Decoder
        self.decoder4 = linknetUp(filters[3], filters[2]) # 512 -> 256
        self.decoder3 = linknetUp(filters[2], filters[1]) # 256 -> 128
        self.decoder2 = linknetUp(filters[1], filters[0]) # 128 -> 64
        self.decoder1 = linknetUp(filters[0], filters[0]) # 64 -> 64

        # Final Classifier
        self.finaldeconvbnrelu1 = nn.Sequential(
                nn.ConvTranspose2d(filters[0], 32/feature_scale, 3, 2, 1,1),
        ...
        self.finalconv3 = nn.Conv2d(32/feature_scale, n_classes, 1, 1)
...
if __name__ == "__main__":
    ...
    net = linknet(feature_scale=1, n_classes=1)
